<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="ComplaintRegistrationNew.aspx.cs" Inherits="Complaint_Management_System.User.ComplaintRegistrationNew" %>
                  ...
                  <h3 class="text-center">Complaint Registration</h3><br>
                    <%--<div>
                     ...
                     <div>
                         ...
                         <rjs:PopCalendar ID="PopCalendar1" runat="server" Control="txtComplaintDate" ControlFocusOnError="True" Format="dd mmm yyyy" />
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtComplaintTitle" ErrorMessage="Enter Complaint Title" ForeColor="#003300" ValidationGroup="s"></asp:RequiredFieldValidator>
                          ...
                          <div>
                              ...
                              <asp:FileUpload ID="FileUpload1" runat="server" ForeColor="#000300" />
                    ...
                    <div>
                        <asp:Button ID="btnSubmit" runat="server" ForeColor="#003300" Text="Submit" ValidationGroup="s" CssClass="btn btn-blue" OnClick="btnSubmit_Click" OnClientClick="btn Submit_Click" />
